...
<span class="line"></span></code></pre></div><h3 id="\u65B0\u5EFA\u7F51\u7AD9\u5E76\u914D\u7F6Essl" tabindex="-1">\u65B0\u5EFA\u7F51\u7AD9\u5E76\u914D\u7F6ESSL <a class="header-anchor" href="#\u65B0\u5EFA\u7F51\u7AD9\u5E76\u914D\u7F6Essl" aria-hidden="true">#</a></h3><p>\u5728\u5B9D\u5854\u9762\u677F\u4E0A\u65B0\u5EFA\u4EE5\u4E0A\u7F51\u7AD9\uFF0C\u90E8\u7F72\u597D SSL \u8BC1\u4E66\u5E76\u5F00\u542F\u5F3A\u5236 HTTPS</p><div class="danger custom-block"><p class="custom-block-title">WARNING</p><p>\u{1F9E8}\u8B66\u544A\uFF1A\u524D\u7AEF\u8981\u6C42\u5F3A\u5236 HTTPS\uFF0C\u672A\u914D\u7F6E SSL \u5C06\u65E0\u6CD5\u6B63\u5E38\u8BBF\u95EE\u3002</p></div><h3 id="\u5B89\u88C5-docker" tabindex="-1">\u5B89\u88C5 docker <a class="header-anchor" href="#\u5B89\u88C5-docker" aria-hidden="true">#</a></h3><div class="language-bash"><pre class="shiki shiki-dark" style="background-color:#121212;"><code><span class="line"><span style="color:#DBD7CA;">sudo curl -fsSL https://get.docker.com </span><span style="color:#CB7676;">|</span><span style="color:#DBD7CA;"> bash -s docker</span></span>
<span class="line"><span style="color:#758575;"># \u5982\u679C\u5B89\u88C5\u6BD4\u8F83\u6162\uFF0C\u63A8\u8350\u4F7F\u7528\u4EE5\u4E0B\u547D\u4EE4</span></span>
<span class="line"><span style="color:#DBD7CA;">sudo curl -fsSL https://get.docker.com </span><span style="color:#CB7676;">|</span><span style="color:#DBD7CA;"> bash -s docker --mirror Aliyun</span></span>
<span class="line"><span style="color:#758575;"># \u6216\u8005\u4F7F\u7528\u56FD\u5185 daocloud \u4E00\u952E\u5B89\u88C5\u547D\u4EE4</span></span>
<span class="line"><span style="color:#DBD7CA;">sudo curl -sSL https://get.daocloud.io/docker </span><span style="color:#CB7676;">|</span><span style="color:#DBD7CA;"> sh</span></span>
<span class="line"></span></code></pre><pre class="shiki shiki-light" style="background-color:#ffffff;"><code><span class="line"><span style="color:#393A34;">sudo curl -fsSL https://get.docker.com </span><span style="color:#AB5959;">|</span><span style="color:#393A34;"> bash -s docker</span></span>
<span class="line"><span style="color:#A0ADA0;"># \u5982\u679C\u5B89\u88C5\u6BD4\u8F83\u6162\uFF0C\u63A8\u8350\u4F7F\u7528\u4EE5\u4E0B\u547D\u4EE4</span></span>
<span class="line"><span style="color:#393A34;">sudo curl -fsSL https://get.docker.com </span><span style="color:#AB5959;">|</span><span style="color:#393A34;"> bash -s docker --mirror Aliyun</span></span>
<span class="line"><span style="color:#A0ADA0;"># \u6216\u8005\u4F7F\u7528\u56FD\u5185 daocloud \u4E00\u952E\u5B89\u88C5\u547D\u4EE4</span></span>
<span class="line"><span style="color:#393A34;">sudo curl -sSL https://get.daocloud.io/docker </span><span style="color:#AB5959;">|</span><span style="color:#393A34;"> sh</span></span>
<span class="line"></span></code></pre></div><h3 id="\u5B89\u88C5-docker-compose" tabindex="-1">\u5B89\u88C5 docker-compose <a class="header-anchor" href="#\u5B89\u88C5-docker-compose" aria-hidden="true">#</a></h3><div class="language-bash"><pre class="shiki shiki-dark" style="background-color:#121212;"><code><span class="line"><span style="color:#758575;"># \u4E0B\u8F7D docker-compose</span></span>
...
<span class="line"><span style="color:#dbd7ca;">JWT_SECRET=aaa                       #\u6B64\u5904\u586B\u5199\u4E00\u4E2A\u968F\u610F\u5B57\u7B26\u4E32\uFF0C\u793A\u4F8B\u5982\uFF1Aaaa</span></span>
...
<span class="line"><span style="color:#393a34;">JWT_SECRET=aaa                       #\u6B64\u5904\u586B\u5199\u4E00\u4E2A\u968F\u610F\u5B57\u7B26\u4E32\uFF0C\u793A\u4F8B\u5982\uFF1Aaaa</span></span>
...
<span class="line"></span></code></pre></div><h3 id="pm2-\u6258\u7BA1\uFF08\u542F\u52A8\uFF09" tabindex="-1">pm2 \u6258\u7BA1\uFF08\u542F\u52A8\uFF09 <a class="header-anchor" href="#pm2-\u6258\u7BA1\uFF08\u542F\u52A8\uFF09" aria-hidden="true">#</a></h3><div class="language-bash"><pre class="shiki shiki-dark" style="background-color:#121212;"><code><span class="line"><span style="color:#DBD7CA;">npm run prod:pm2</span></span>
...
<span class="line"><span style="color:#393A34;">}</span></span>
<span class="line"></span></code></pre></div><p>\u63A5\u4E0B\u6765\u8BBF\u95EE <a href="https://www.test.cn/" target="_blank" rel="noopener noreferrer">https://www.test.cn/</a> \uFF0C\u770B\u770B\u8FD0\u884C\u662F\u5426\u6B63\u5E38\u3002</p><h2 id="\u540E\u53F0\u8BBE\u7F6E" tabindex="-1">\u540E\u53F0\u8BBE\u7F6E <a class="header-anchor" href="#\u540E\u53F0\u8BBE\u7F6E" aria-hidden="true">#</a></h2><p>\u8BE5\u8282\u5185\u5BB9\u5728 <a href="/options/adsetting.html">\u540E\u53F0\u8BBE\u7F6E</a></p><h2 id="\u6B4C\u5355-\u8FFD\u756A\u8BBE\u7F6E" tabindex="-1">\u6B4C\u5355 / \u8FFD\u756A\u8BBE\u7F6E <a class="header-anchor" href="#\u6B4C\u5355-\u8FFD\u756A\u8BBE\u7F6E" aria-hidden="true">#</a></h2><p>\u8BE5\u8282\u5185\u5BB9\u5728 <a href="/options/serverless.html">\u4E91\u51FD\u6570\u914D\u7F6E\u793A\u4F8B</a>\uFF0C\u4E14\u662F Kami v 3.5.0 \u53CA\u4EE5\u4E0A\u5FC5\u987B\u7684\u8FC7\u7A0B\u3002</p><h2 id="\u641C\u7D22" tabindex="-1">\u641C\u7D22 <a class="header-anchor" href="#\u641C\u7D22" aria-hidden="true">#</a></h2><p>kami V3 \u5DF2\u7ECF\u641C\u7D22\u529F\u80FD\u5DF2\u7ECF\u5B8C\u6210\uFF0C\u5177\u4F53\u914D\u7F6E\u65B9\u6CD5\u8BF7\u53C2\u8003<a href="/options/adsetting.html#algolia-search">\u540E\u53F0\u8BBE\u7F6E-algolia</a>\u3002</p><h2 id="kami\u8BBE\u7F6E" tabindex="-1">Kami\u8BBE\u7F6E <a class="header-anchor" href="#kami\u8BBE\u7F6E" aria-hidden="true">#</a></h2><p>\u8BE5\u8282\u5185\u5BB9\u5728 <a href="/options/">Kami v3\u8BBE\u7F6E</a></p>`,89),e=[o];function c(r,t,y,i,d,A){return n(),a("div",null,e)}var h=s(p,[["render",c]]);export{B as __pageData,h as default};
